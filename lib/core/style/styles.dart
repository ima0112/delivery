...
class Corners {
  ...
  static const double custom = 10;
  static const BorderRadius customBorder = BorderRadius.all(customRadius);
  static const Radius customRadius = Radius.circular(custom);
}
...
class Shadows {
  static List<BoxShadow> get custom => [
        BoxShadow(
            color: Color(0xff333333).withOpacity(.3),
            spreadRadius: 0,
            blurRadius: 10),
      ];
...
class LinearGradients {
  static LinearGradient get customBoth => LinearGradient(
        stops: [
          0.0,
          0.03,
          0.97,
  ...
  static LinearGradient get customRight => LinearGradient(
        stops: [
          0.97,
          1.0,
        ],
  ...
  static LinearGradient get customLeft => LinearGradient(
        stops: [
          0.0,
          0.03,
        ],
...
class TextStyles {
  ...
  static TextStyle lato =
      GoogleFonts.lato(fontWeight: FontWeight.w400, height: 1);
  ...
  static TextStyle get callout1 => lato.copyWith(
